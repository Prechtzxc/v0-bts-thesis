...
export default function SchedulingPage() {
  ...
  const loadSchedules = async () => {
    try {
      const verificationLoaded = await getVerificationSchedules()
      const financialLoaded = await getFinancialDistributionSchedules()
  ...
  const handleAddSchedule = async () => {
    ...
    try {
      if (activeTab === "verification") {
        await createVerificationSchedule({
        ...
        for (const barangay of formData.barangays) {
