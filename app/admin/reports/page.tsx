...
export default function ReportsPage() {
  ...
  const getYearLevelData = () => {
    if (!scholars || scholars.length === 0) {
      return [
        { name: "1st Year", value: 0, fill: "#3b82f6" },
        { name: "2nd Year", value: 0, fill: "#10b981" },
        { name: "3rd Year", value: 0, fill: "#f59e0b" },
        { name: "4th Year", value: 0, fill: "#ef4444" },
      ]
    }
    
    const yearLevels = scholars.reduce(
      (acc, scholar) => {
        const profile = scholar.profileData || scholar
    ...
    const data = ["1st Year", "2nd Year", "3rd Year", "4th Year"].map((name) => ({
      name,
      value: yearLevels[name] || 0,
  ...
  const getAgeData = () => {
    if (!scholars || scholars.length === 0) {
      return [
        { name: "16-18", value: 0, fill: "#3b82f6" },
        { name: "19-21", value: 0, fill: "#10b981" },
        { name: "22-24", value: 0, fill: "#f59e0b" },
        { name: "25+", value: 0, fill: "#ef4444" },
      ]
    }
