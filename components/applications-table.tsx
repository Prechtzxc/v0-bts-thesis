...
export function ApplicationsTable({ limit }: ApplicationsTableProps) {
  ...
  const handleApproveApplication = async (applicationId: string) => {
    try {
      const updatedApplication = await updateApplication(applicationId, { status: "approved" })
  ...
  const handleRejectApplication = async (applicationId: string) => {
    try {
      const updatedApplication = await updateApplication(applicationId, { status: "rejected" })
